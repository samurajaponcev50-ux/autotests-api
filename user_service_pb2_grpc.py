...
class UserServiceStub:
    ...
    def __init__(self, channel):
        ...
        self.GetUser = channel.unary_unary(
                ...
                response_deserializer=user__service__pb2.GetUserResponce.FromString,
...
def add_UserServiceServicer_to_server(servicer, server):
    rpc_method_handlers = {
            'GetUser': grpc.unary_unary_rpc_method_handler(
                    ...
                    response_serializer=user__service__pb2.GetUserResponce.SerializeToString,
            ),
    }
...
class UserService:
    ...
    def GetUser(request,
        ...
        return grpc.experimental.unary_unary(
            ...
            user__service__pb2.GetUserResponce.FromString,
            options,
            channel_credentials,
            insecure,
            call_credentials,
